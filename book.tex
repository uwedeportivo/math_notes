...
\subimport{minkowski_sum/}{minkowski_sum_content.tex}
...
\subimport{divisible_by_three/}{divisible_by_three_content.tex}

\clearpage
\chapter{Dutch National Flag}
\subimport{dutch_national_flag/}{dutch_national_flag_content.tex}

\clearpage
\chapter{Bernoulli Inequality}
\subimport{bernoulli/}{bernoulli_content.tex}

\clearpage
\chapter{Completeness}
\subimport{completeness/}{completeness_content.tex}

\clearpage
\chapter{Enigma}
\subimport{enigma/}{enigma_content.tex}

\clearpage
\chapter{Burnside P\'{o}lya Counting}
\subimport{burnside_polya/}{burnside_polya_content.tex}

\clearpage
\chapter{Two algebraic delights}
\subimport{two_algebraic_delights/}{two_algebraic_delights_content.tex}

\clearpage
\chapter{Sequences and Series}
\subimport{series/}{series_content.tex}

\clearpage
\chapter{Existence of n-th Root}
\subimport{nthroot/}{nthroot_content.tex}
\includepdf[pages=-,pagecommand={},scale=.8]{nthroot/nthroot.pdf}
